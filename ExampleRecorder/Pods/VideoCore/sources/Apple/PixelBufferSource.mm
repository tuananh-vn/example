...
namespace videocore { namespace Apple {
    ...
    void
    PixelBufferSource::pushPixelBuffer(CVPixelBufferRef pixelBufferData)
    {
        ...
        if(outp) {
            ...
            VideoBufferMetadata md(0.);
            md.setData(4, mat, true, shared_from_this());
            auto pixelBuffer = std::make_shared<Apple::PixelBuffer>((CVPixelBufferRef)pixelBufferData, false);
            outp->pushBuffer((const uint8_t*)&pixelBuffer, sizeof(pixelBuffer), md);
        }
    }
    void
